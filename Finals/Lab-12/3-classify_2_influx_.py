...
INFLUXDB_TOKEN = "Sgqz5EjtMeez9pEMOmEmeHBQ-7vSCZYkJEqo1_HBBpyIAz72RX3O6-LtQChNipWmi-hbJDV-cVxS00CDOvAu6w=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "iotlab"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "sensor_data"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.186.172"  # ESP32's MQTT broker address
